...
exports.createPaymentSession = functions
  ...
  .https.onCall(async (data, context) => {
    try {
      ...
      //const adminSetDate = data.setDate;
      ...
      //if (amount <= 29999 || amount > MAX_AMOUNT) {
      ...
      const payload = {
        ...
        expiration: moment().add(15, "minutes").toISOString(), // 15 minutes expiration
      ...
      // Make the API request to PlaceToPay https://checkout.avalpaycenter.com/api/session
      ...
      if (
        ...
        const transactionData = {
          ...
          //empresaAdminSetDate: new Date(adminSetDate),
