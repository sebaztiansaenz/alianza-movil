...
import 'retirosbank_model.dart';
export 'retirosbank_model.dart';

class RetirosbankWidget extends StatefulWidget {
  const RetirosbankWidget({super.key});

  static String routeName = 'retirosbank';
  static String routePath = '/retirosbank';

  @override
  State<RetirosbankWidget> createState() => _RetirosbankWidgetState();
}

class _RetirosbankWidgetState extends State<RetirosbankWidget> {
  late RetirosbankModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RetirosbankModel());
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.accountNumberTextController
                                          ...
                                          context.pushNamed(
                                            ModalCopyCopy3Widget.routeName,
