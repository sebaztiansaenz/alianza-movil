...
class ModalWidget extends StatefulWidget {
  ...
  static String routeName = 'modal';
  static String routePath = '/modal';
...
class _ModalWidgetState extends State<ModalWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<AhorrosRecord>(
      stream: AhorrosRecord.getDocument(widget!.ahorro!),
      builder: (context, snapshot) {
        ...
        final modalAhorrosRecord = snapshot.data!;
                              ...
                              queryBuilder: (transactionsRecord) =>
                                  transactionsRecord
                                      .where(
                                        'ahorrosId',
                                        isEqualTo:
                                            modalAhorrosRecord.reference.id,
                                      )
                                      .orderBy('firebaseDate',
                                          descending: true),
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
