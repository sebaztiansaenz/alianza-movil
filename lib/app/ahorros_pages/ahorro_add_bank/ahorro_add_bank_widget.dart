...
import 'ahorro_add_bank_model.dart';
export 'ahorro_add_bank_model.dart';

class AhorroAddBankWidget extends StatefulWidget {
  const AhorroAddBankWidget({super.key});

  static String routeName = 'AhorroAddBank';
  static String routePath = '/ahorroAddBank';

  @override
  State<AhorroAddBankWidget> createState() => _AhorroAddBankWidgetState();
}

class _AhorroAddBankWidgetState extends State<AhorroAddBankWidget> {
  late AhorroAddBankModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AhorroAddBankModel());
                                    ...
                                    onPressed: () async {
                                      ...
                                      if ((_model.accountNumberTextController
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Introduce datos bancarios válidos',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
