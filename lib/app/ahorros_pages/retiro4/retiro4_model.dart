...
import '/index.dart';
import 'retiro4_widget.dart' show Retiro4Widget;
...
class Retiro4Model extends FlutterFlowModel<Retiro4Widget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in retiro4 widget.
  List<AhorrosRecord>? ahorross;
  // Stores action output result for [Custom Action - getTotalForAccount] action in retiro4 widget.
  List<TotalDepositoAhorroStruct>? transactionsTotal;
  // Stores action output result for [Custom Action - withdrawalTotalAhorros] action in retiro4 widget.
