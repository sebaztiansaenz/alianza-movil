...
import '/index.dart';
import 'retiro2new_copy_widget.dart' show Retiro2newCopyWidget;
...
class Retiro2newCopyModel extends FlutterFlowModel<Retiro2newCopyWidget> {
  ///  Local state fields for this page.

  AhorrosRecord? seleccionado;
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in retiro2newCopy widget.
  List<AhorrosRecord>? ahorros;
  // Stores action output result for [Custom Action - getTotalForAccount] action in retiro2newCopy widget.
  List<TotalDepositoAhorroStruct>? transactionsTotal;
  // Stores action output result for [Custom Action - withdrawalTotalAhorros] action in retiro2newCopy widget.
