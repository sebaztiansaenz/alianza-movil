...
import '/index.dart';
import 'retiro2new_copy_copy_widget.dart' show Retiro2newCopyCopyWidget;
...
class Retiro2newCopyCopyModel
    extends FlutterFlowModel<Retiro2newCopyCopyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in retiro2newCopyCopy widget.
  List<AhorrosRecord>? ahorrosQuery;
  // Stores action output result for [Custom Action - getTotalForAccount] action in retiro2newCopyCopy widget.
  List<TotalDepositoAhorroStruct>? depositosAhorrosTotal;
  // Stores action output result for [Custom Action - withdrawalTotalAhorros] action in retiro2newCopyCopy widget.
