...
import 'cdatretiros_model.dart';
export 'cdatretiros_model.dart';

class CdatretirosWidget extends StatefulWidget {
  const CdatretirosWidget({
    super.key,
    this.cdatsss,
  });
  ...
  @override
  State<CdatretirosWidget> createState() => _CdatretirosWidgetState();
}

class _CdatretirosWidgetState extends State<CdatretirosWidget> {
  late CdatretirosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CdatretirosModel());
                    ...
                    Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          context.pushNamed(
                            CdatretiroWidget.routeName,
                            queryParameters: {
                              'cdatr': serializeParam(
                                widget!.cdatsss,
                                ParamType.Document,
                              ),
                            }.withoutNulls,
                            extra: <String, dynamic>{
                              'cdatr': widget!.cdatsss,
