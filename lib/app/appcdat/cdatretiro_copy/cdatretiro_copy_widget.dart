...
import 'cdatretiro_copy_model.dart';
export 'cdatretiro_copy_model.dart';

class CdatretiroCopyWidget extends StatefulWidget {
  const CdatretiroCopyWidget({
    super.key,
    required this.cdatr,
  });
  ...
  static String routeName = 'cdatretiroCopy';
  static String routePath = '/cdatretiroCopy';

  @override
  State<CdatretiroCopyWidget> createState() => _CdatretiroCopyWidgetState();
}

class _CdatretiroCopyWidgetState extends State<CdatretiroCopyWidget> {
  late CdatretiroCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CdatretiroCopyModel());
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            height: valueOrDefault<double>(
                              MediaQuery.sizeOf(context).height * 0.12324,
                              104.0,
                            ),
                            decoration: BoxDecoration(),
                            child: Container(
