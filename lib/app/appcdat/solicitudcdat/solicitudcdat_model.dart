...
import '/index.dart';
import 'solicitudcdat_widget.dart' show SolicitudcdatWidget;
...
class SolicitudcdatModel extends FlutterFlowModel<SolicitudcdatWidget> {
  ...
  // Stores action output result for [Custom Action - getJson] action in solicitudcdat widget.
  dynamic? ciudadbf;
