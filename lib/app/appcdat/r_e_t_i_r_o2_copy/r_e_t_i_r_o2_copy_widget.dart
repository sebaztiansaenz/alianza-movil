...
import 'r_e_t_i_r_o2_copy_model.dart';
export 'r_e_t_i_r_o2_copy_model.dart';

class RETIRO2CopyWidget extends StatefulWidget {
  const RETIRO2CopyWidget({
    super.key,
    required this.cdat,
  });
  ...
  static String routeName = 'RETIRO2Copy';
  static String routePath = '/rETIRO2Copy';

  @override
  State<RETIRO2CopyWidget> createState() => _RETIRO2CopyWidgetState();
}

class _RETIRO2CopyWidgetState extends State<RETIRO2CopyWidget> {
  late RETIRO2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RETIRO2CopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CdatsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final rETIRO2CopyCdatsRecord = snapshot.data!;
                                              ...
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  '${rETIRO2CopyCdatsRecord.ea.toString()}% E.A.',
                                                                              ...
                                                                              builder: (context) {
                                                                                return GestureDetector(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: AhorrosWithdrawalModalCdatWidget(
                                                                                      cdatss: widget!.cdat!,
                                                                                      bank: listViewBankAccountsRecord,
                                                                                    ),
                                                                                  ),
                                                                                );
                                                                              },
