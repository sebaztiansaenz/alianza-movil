...
import '/index.dart';
import 'r_e_t_i_r_o2_copy_widget.dart' show RETIRO2CopyWidget;
...
class RETIRO2CopyModel extends FlutterFlowModel<RETIRO2CopyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in RETIRO2Copy widget.
  List<AhorrosRecord>? ahorross;
  // Stores action output result for [Custom Action - getTotalForAccount] action in RETIRO2Copy widget.
  List<TotalDepositoAhorroStruct>? transactionsTotal;
  // Stores action output result for [Custom Action - withdrawalTotalAhorros] action in RETIRO2Copy widget.
