...
import 'ahorros_withdrawal_modal_cdat_model.dart';
export 'ahorros_withdrawal_modal_cdat_model.dart';

class AhorrosWithdrawalModalCdatWidget extends StatefulWidget {
  const AhorrosWithdrawalModalCdatWidget({
    super.key,
  ...
  @override
  State<AhorrosWithdrawalModalCdatWidget> createState() =>
      _AhorrosWithdrawalModalCdatWidgetState();
}

class _AhorrosWithdrawalModalCdatWidgetState
    extends State<AhorrosWithdrawalModalCdatWidget> {
  late AhorrosWithdrawalModalCdatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AhorrosWithdrawalModalCdatModel());
