...
import 'perfil07_edit_model.dart';
export 'perfil07_edit_model.dart';

class Perfil07EditWidget extends StatefulWidget {
  const Perfil07EditWidget({super.key});

  static String routeName = 'Perfil_07Edit';
  static String routePath = '/perfil07Edit';

  @override
  State<Perfil07EditWidget> createState() => _Perfil07EditWidgetState();
}

class _Perfil07EditWidgetState extends State<Perfil07EditWidget> {
  late Perfil07EditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Perfil07EditModel());
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                context.pushNamed(Perfil07Widget.routeName);
