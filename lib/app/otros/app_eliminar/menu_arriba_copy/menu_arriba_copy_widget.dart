...
import 'menu_arriba_copy_model.dart';
export 'menu_arriba_copy_model.dart';

class MenuArribaCopyWidget extends StatefulWidget {
  const MenuArribaCopyWidget({
    super.key,
    bool? black,
    required this.text,
  ...
  @override
  State<MenuArribaCopyWidget> createState() => _MenuArribaCopyWidgetState();
}

class _MenuArribaCopyWidgetState extends State<MenuArribaCopyWidget> {
  late MenuArribaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuArribaCopyModel());
