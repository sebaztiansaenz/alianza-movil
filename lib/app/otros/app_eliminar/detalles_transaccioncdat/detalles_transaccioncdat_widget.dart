...
import 'detalles_transaccioncdat_model.dart';
export 'detalles_transaccioncdat_model.dart';

class DetallesTransaccioncdatWidget extends StatefulWidget {
  const DetallesTransaccioncdatWidget({
    super.key,
  ...
  static String routeName = 'DetallesTransaccioncdat';
  static String routePath = '/detallesTransaccioncdat';

  @override
  State<DetallesTransaccioncdatWidget> createState() =>
      _DetallesTransaccioncdatWidgetState();
}

class _DetallesTransaccioncdatWidgetState
    extends State<DetallesTransaccioncdatWidget> {
  late DetallesTransaccioncdatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetallesTransaccioncdatModel());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(
                              ComprobantescdatWidget.routeName,
                              queryParameters: {
