...
import 'ahorros_deposit_confirmation_model.dart';
export 'ahorros_deposit_confirmation_model.dart';

class AhorrosDepositConfirmationWidget extends StatefulWidget {
  const AhorrosDepositConfirmationWidget({
    super.key,
  ...
  @override
  State<AhorrosDepositConfirmationWidget> createState() =>
      _AhorrosDepositConfirmationWidgetState();
}

class _AhorrosDepositConfirmationWidgetState
    extends State<AhorrosDepositConfirmationWidget> {
  late AhorrosDepositConfirmationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AhorrosDepositConfirmationModel());
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (_model.cloudFunctionf1f!.succeeded!) {
                          FFAppState().lastPayment =
                              functions.twelveMinsLater();
                          safeSetState(() {});
