...
import '/index.dart';
import 'retiro4_copy_widget.dart' show Retiro4CopyWidget;
...
class Retiro4CopyModel extends FlutterFlowModel<Retiro4CopyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in retiro4Copy widget.
  List<AhorrosRecord>? ahorross;
  // Stores action output result for [Custom Action - getTotalForAccount] action in retiro4Copy widget.
  List<TotalDepositoAhorroStruct>? transactionsTotal;
  // Stores action output result for [Custom Action - withdrawalTotalAhorros] action in retiro4Copy widget.
