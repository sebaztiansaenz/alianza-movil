import '/app/appcdat/ahorros_withdrawal_modal_cdat_copy/ahorros_withdrawal_modal_cdat_copy_widget.dart';
...
import 'retiro4_copy_model.dart';
export 'retiro4_copy_model.dart';

class Retiro4CopyWidget extends StatefulWidget {
  const Retiro4CopyWidget({
    super.key,
    required this.productRef,
    required this.banco,
  });

  final CdatsRecord? productRef;
  final DocumentReference? banco;

  static String routeName = 'retiro4Copy';
  static String routePath = '/retiro4Copy';

  @override
  State<Retiro4CopyWidget> createState() => _Retiro4CopyWidgetState();
}

class _Retiro4CopyWidgetState extends State<Retiro4CopyWidget> {
  late Retiro4CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Retiro4CopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CdatsRecord>(
      stream: CdatsRecord.getDocument(widget!.productRef!.reference),
      builder: (context, snapshot) {
        ...
        final retiro4CopyCdatsRecord = snapshot.data!;
                                                                                ...
                                                                                child: Text(
                                                                                  valueOrDefault<String>(
                                                                                    functions.formatAmount(valueOrDefault<double>(
                                                                                      retiro4CopyCdatsRecord.saldoDisponible,
                                                                                      0.0,
                                                                                    )),
                                                                                    '\$ 0',
                                                                                  ),
                                                ...
                                                return GestureDetector(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Container(
                                                      height: 328.0,
                                                      child:
                                                          AhorrosWithdrawalModalCdatCopyWidget(
                                                        cdatss:
                                                            widget!.productRef!,
                                                        bank: widget!.banco!,
                                                      ),
