...
import 'solicitarcrdito6_model.dart';
export 'solicitarcrdito6_model.dart';

class Solicitarcrdito6Widget extends StatefulWidget {
  const Solicitarcrdito6Widget({
    super.key,
  ...
  static String routeName = 'SOLICITARCRDITO-6';
  static String routePath = '/solicitarcrdito6';

  @override
  State<Solicitarcrdito6Widget> createState() => _Solicitarcrdito6WidgetState();
}

class _Solicitarcrdito6WidgetState extends State<Solicitarcrdito6Widget> with SessionActivityOnInitMixin {
  late Solicitarcrdito6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Solicitarcrdito6Model());
                      ...
                      children: [
                        ...
                        if (_model.otrasfuentres == 'Si')
                          Column(
                            ...
                            children: [
                              Text(
                                '¿Cuántos créditos activos tiene actualmente?',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Satoshi',
                              ...
                              InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  _model.creditosActivos = '4 o más';
                                  safeSetState(() {});
                                },
                                child: Container(
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                ...
                                0.0),
                            child: Text(
                              '¿Cuánto pagas en total al mes por todos tus créditos activos?',
                    ...
                    Builder(
                      builder: (context) => Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if (_model.otrasfuentres == 'Si') {
                              if ((_model.creditosActivos != null &&
                                      _model.creditosActivos != '') &&
                                  (_model.amountTextController.text != null &&
                                      _model.amountTextController.text != '')) {
                                context.pushNamed(
                                  SOLICITARCRDITO6CopyWidget.routeName,
                                  queryParameters: {
